...
KEYWORDS = [
    ...
    "sokongan","rintangan","resisten","bermula","jatuh","naik","kawasan","tempat","masuk","keluar",
    ...
    "fullback","follback","pull back","weekly","monthly","h4","h1","m15","m5","m3","m1",
    "first left","ftr","sbr","rbs","rss","srr"
]
